    ...
    (function ($) {
        ...
        Wizard.prototype = {
            ...
            setState: function () {
                ...
                this.$element.find('.steps').first().attr('style', 'margin-right: 0');
                ...
                if (containerWidth > 900) {
                    if (totalWidth > containerWidth) {
                        ...
                        var test = this.$element.find('li.active').first().position();
                        var rightposition = totalWidth - test.left;
                        if (test.left < 0) {
                            newMargin = test.left;
                            if (newMargin < 1) {
                                this.$element.find('.steps').first().attr('style', 'margin-right: ' + newMargin + 'px');
                            } else {
                                this.$element.find('.steps').first().attr('style', 'margin-left: -' + newMargin + 'px');
                            }
